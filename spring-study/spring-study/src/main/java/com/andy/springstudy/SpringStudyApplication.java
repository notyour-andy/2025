...
import com.andy.springstudy.condition.Condition2;
...
//        }
        ...
        //测试condition1
//        User user = defaultContext.getBean("conditional1User", User.class);
        //测试condition2
//        Eggs eggs = defaultContext.getBean("condition2Eggs", Eggs.class);
        //测试condition3
//        Foo foo = defaultContext.getBean("condition3Foo", Foo.class);
        //测试condition4
        Foo foo = defaultContext.getBean("condition4Foo", Foo.class);
